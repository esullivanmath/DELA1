...
\subsection{Undetermined Coefficients (FINISH)}
FINISH
...
\section{First Order Modeling Problems (FINISH)}
{\color{blue} In this section I intend to show a few modeling problems with fully worked solutions to
the resulting difference or differential equation}
