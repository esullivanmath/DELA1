...
\section{Labs and Explorations for Difference and Differential Equations}
...
\begin{problem}
    For each of the following situations, write a first order nonhomogeneous linear
    differential equation, find the general solution to the differential equation, and use
    the given information to find all of the all of the constants and parameters.
    \begin{enumerate}
